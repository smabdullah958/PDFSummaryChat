    ...
    <div>
      {IsLogIn && (
        <button
          ...
          disabled={Loading}
          className={`px-6 py-2 md:mr-10 rounded-xl  bg-gradient-to-r from-[#3fb7eb] to-[#23a4dc] text-white font-semibold shadow-lg  transition-all duration-500 transform hover:scale-105 active:scale-95  ${IsLogIn ? "opacity-100 hover:from-[#0693cf] hover:to-[#0f94cd]" : "opacity-0"} ${Loading ? "opacity-40 cursor-not-allowed bg-gray-200" : ""}`}
        >
